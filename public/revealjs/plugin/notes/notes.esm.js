    ...
    return (n, i, s) => {
        ...
        if (i.async)
            return Promise.resolve(i.hooks ? i.hooks.preprocess(n) : n)
                ...
                .then((t) =>
                    i.walkTokens
                        ? Promise.all(O.walkTokens(t, i.walkTokens)).then(
                              () => t
                          )
                        : t
                )
...
;(O.options = O.setOptions =
    function (t) {
        var n
        return (
            (O.defaults = { ...O.defaults, ...t }), (n = O.defaults), (e = n), O
        )
    }),
    (O.getDefaults = t),
    (O.defaults = e),
            ...
            switch (((n = n.concat(e.call(O, i))), i.type)) {
                case 'table':
                    for (const t of i.header)
                        n = n.concat(O.walkTokens(t.tokens, e))
                    for (const t of i.rows)
                        for (const i of t)
                            n = n.concat(O.walkTokens(i.tokens, e))
                    break
                case 'list':
                ...
                default:
                    ...
                    O.defaults.extensions.childTokens[i.type]
                        ? O.defaults.extensions.childTokens[i.type].forEach(
                              function (t) {
