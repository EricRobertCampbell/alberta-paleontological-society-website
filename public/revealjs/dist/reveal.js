        ...
        startEmbeddedContent(e) {
            if (e) {
                ...
                ;(t(e, 'img[src$=".gif"]').forEach((e) => {
                    ...
                    t(e, 'video, audio').forEach((e) => {
                        if (r(e, '.fragment') && !r(e, '.fragment.visible'))
                            return
    ...
    class R {
        ...
        update(e = !1) {
            ...
            if (
                ...
                let e = this.previousBackground.getAttribute(
                        'data-background-hash'
                    ),
    ...
    function $(n, o) {
        ...
        function ye() {
            !1 !== k &&
                ((D = !0),
                A.showHiddenSlides ||
                    t(Y.wrapper, 'section[data-visibility="hidden"]').forEach(
                        (e) => {
        ...
        function Ee(t) {
            ...
            ;(Y.wrapper.classList.remove(s.transition),
                ...
                A.previewLinks
                    ...
                    : (Ne(),
                      Te('[data-preview-link]:not([data-preview-link=false])')),
                se.reset(),
                w && (w.destroy(), (w = null)),
                a > 1 &&
                    A.autoSlide &&
        ...
        function Be() {
            return (
                !!Y.overlay &&
                (Y.overlay.parentNode.removeChild(Y.overlay),
                (Y.overlay = null),
                !0)
            )
        }
        ...
        function De(e, i) {
            t(Y.slides, 'section > .stretch, section > .r-stretch').forEach(
                (t) => {
                    let s = ((e, t = 0) => {
                        if (e) {
                            let i,
        ...
        function Ye(e, i, s, a) {
            ...
            ;(n.classList.toggle('is-vertical-slide', m.length > 1),
                (p = m[h] || v))
            let b = !1
            ;(u &&
                g &&
            ...
            ;(u && xe(a),
                (!u && g) ||
                    (ee.stopEmbeddedContent(g), ee.startEmbeddedContent(p)),
                requestAnimationFrame(() => {
                    be(we(p))
                }),
                ue.update(),
        ...
        function ft({ skipFragments: e = !1 } = {}) {
            if (((q.hasNavigatedHorizontally = !0), ne.isActive()))
                return ne.prev()
            A.rtl
        ...
        function wt({ skipFragments: e = !1 } = {}) {
            if (((q.hasNavigatedVertically = !0), ne.isActive()))
                return ne.next()
            ;(le.isActive() || e || !1 === oe.next()) &&
                it().down &&
                Ye(c, h + 1)
        ...
        function xt(e) {
            ;(document.fullscreenElement ||
                document.webkitFullscreenElement) === Y.wrapper &&
            ...
            destroy: function () {
                ;((k = !1),
                    !1 !== D &&
                        ...
                        Array.from(Y.wrapper.querySelectorAll(m)).forEach(
                            (e) => {
