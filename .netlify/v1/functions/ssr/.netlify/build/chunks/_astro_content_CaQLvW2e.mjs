...
import { A as AstroError, w as UnknownContentCollectionError, c as createComponent, R as RenderUndefinedEntryError, u as unescapeHTML, a as renderTemplate, x as renderUniqueStylesheet, y as renderScriptElement, z as createHeadAndContent, r as renderComponent } from './astro/server_S4n-JgDR.mjs';
import 'kleur/colors';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_BGlqTyca.mjs');
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_DkD09chb.mjs').then(n => n._);
