...
</p> ${randomImage && renderTemplate`<section class="random-fossil" data-astro-cid-azt24f46> <h2 data-astro-cid-azt24f46>Featured Discovery</h2> <div class="random-fossil__content" data-astro-cid-azt24f46> <img${addAttribute(randomImage.src, "src")}${addAttribute(randomImage.description, "alt")} class="random-fossil__image" loading="lazy" data-astro-cid-azt24f46> <div class="random-fossil__details" data-astro-cid-azt24f46> <p class="random-fossil__description" data-astro-cid-azt24f46>${randomImage.description}</p> <p class="random-fossil__date" data-astro-cid-azt24f46><strong data-astro-cid-azt24f46>Date:</strong> ${formatDateString(randomImage.date)}</p> <p class="random-fossil__credits" data-astro-cid-azt24f46> <strong data-astro-cid-azt24f46>Finder:</strong> ${randomImage.finderCredit}<br data-astro-cid-azt24f46> <strong data-astro-cid-azt24f46>Photo:</strong> ${randomImage.photoCredit} </p> </div> </div> </section>`}<p data-astro-cid-azt24f46>
