import { c as createComponent, b as createAstro, m as maybeRenderHead, d as addAttribute, h as renderSlot, a as renderTemplate, f as renderScript, r as renderComponent } from '../chunks/astro/server_DfjRAjzK.mjs';
import 'kleur/colors';
import { $ as $$Layout, a as $$SocialsLinks } from '../chunks/Layout_CIWrSEVh.mjs';
import { $ as $$Event } from '../chunks/Event_CvC2GvxC.mjs';
import 'clsx';
import { g as generateEventDateTimeString, a as getTodayString } from '../chunks/functions_UiSr9xwT.mjs';
/* empty css                                 */
...
const $$FossilFriday = createComponent(async ($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<div id="fossil-friday-container"></div>  ${renderScript($$result, "/Users/ericr/documents/alberta-paleontological-society-website/src/components/FossilFriday.astro?astro&type=script&index=0&lang.ts")}`;
}, "/Users/ericr/documents/alberta-paleontological-society-website/src/components/FossilFriday.astro", void 0);
