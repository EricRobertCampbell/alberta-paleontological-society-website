...
import { A as AstroError, v as UnknownContentCollectionError, c as createComponent, R as RenderUndefinedEntryError, w as unescapeHTML, a as renderTemplate, x as renderUniqueStylesheet, y as renderScriptElement, z as createHeadAndContent, r as renderComponent } from './astro/server_DfjRAjzK.mjs';
import 'kleur/colors';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_BNfwdv8W.mjs');
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_ClF8C1mt.mjs').then(n => n._);
